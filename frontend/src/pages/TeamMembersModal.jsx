  ...
  return (
    ...
    >
      <div className="p-6 sm:p-7">
        ...
        {members.length === 0 ? (
          <div
            className={`mt-6 rounded-2xl border px-5 py-10 text-center ${theme.softSurface}`}
          >
            ...
            <p className={`mt-1 text-xs ${theme.muted}`}>
              I membri della squadra appariranno qui.
            </p>
          </div>
        ) : (
                  ...
                  {team?.role === "owner" && !isCurrentUser && (
                    <div className="mt-4 grid grid-cols-2 gap-2">
                      <button
                        ...
                        className={`min-h-11 rounded-xl border px-2 text-xs font-bold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink-500 ${theme.secondary}`}
                      >
                        Rendi proprietario
                      </button>
                      ...
                      <button
                        ...
                        className="min-h-11 rounded-xl bg-rose-500/10 px-2 text-xs font-bold text-rose-500 transition hover:bg-rose-500/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500"
                      >
                        Rimuovi
                      </button>
                    </div>
